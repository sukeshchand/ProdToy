...
class ColorPickerPopup : Form
{
    ...
    private void CreateInputControls()
    {
        ...
        // No OK/Cancel — every interaction (spectrum drag, hue drag, swatch
        // click, hex/RGB edit) commits live via ColorSelected. The popup
        // closes on Esc/Enter/click-outside and keeps whatever the live
        // value is.
    }
