...
{
    /// <summary>The fixed red brand icon (teddy bear + gear), loaded from the
    /// embedded PNG. <paramref name="primary"/> is ignored — the icon is always
    /// red, independent of theme. Kept for call-site compatibility.</summary>
